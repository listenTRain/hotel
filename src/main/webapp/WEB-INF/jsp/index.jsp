...
<div class="layui-layout layui-layout-admin">
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-right">
			...
			<li class="layui-nav-item" style="margin-left: 30px;"><iframe  name="weather_inc" src="http://i.tianqi.com/index.php?c=code&id=10" width="160" height="25" frameborder="0"  marginwidth="0" marginheight="0" scrolling="no" ></iframe></li>
			<li class="layui-nav-item">
						...
						<div carousel-item style="height: 750px;">
							<div>
								<div class="layui-bg-green demo-carousel">
									<p style="font-size: 30px;">凯氏集团酒店管理系统</p>
							...
							<div>
								<div class="layui-bg-cyan demo-carousel" style="background-image: url(http://q6eepizvg.bkt.clouddn.com/1.jpg)">
									<p style="font-size: 30px;">凯氏集团酒店管理系统</p>
									<p style="font-size: 28px;">${loginUser.username }</p>
								</div>
							</div>

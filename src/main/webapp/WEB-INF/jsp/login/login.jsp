...
<body >
	<div class="qiqiu1 qiqiu">
		<img src="http://q6eepizvg.bkt.clouddn.com/q2.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu2 qiqiu">
		<img src="http://q6eepizvg.bkt.clouddn.com/q3.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu3 qiqiu">
		<img src="http://q6eepizvg.bkt.clouddn.com/q4.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu4 qiqiu">
		<img src="http://q6eepizvg.bkt.clouddn.com/q5.png" />
		<div class="text">韦氏集团</div>
	</div>
	<div class="qiqiu5 qiqiu">
		<img src="http://q6eepizvg.bkt.clouddn.com/q6.png" />
		<div class="text">韦氏集团</div>
	</div>
	...
	<div class="login" style="height: 300px;">
		...
		<form class="layui-form" action="" lay-filter="example">
			...
			<div class="layui-form-item">
				...
				<p align="center"><img src="user/getVerifyCode" onclick=flushCheckCode(this); title="点击刷新验证码" alt="点击刷新验证码" style="cursor: hand" id="pic1"/></p>
		    	<p style="cursor: pointer;color: #1614a3;font-size: 14px" id="flush1" align="center">点击刷新</p>
			</div>

...
public class QiNiuUtil {
    ...
    static String ACCESS_KEY = "S9xoAGaHcx3oFZ5CelhPHnKspyNZXlaLRyNUzRQW";
    static String SECRET_KEY = "SL6JZQeGFdF4aXdrJYC8SwWBIah9sJfmxV0-OqJS";
    //要上传的空间;对应到七牛上（自己建文件夹 注意设置公开）
    static String bucketname = "hotelimage0228"; //必须改
    //访问此空间的域名
    static String yName = "http://q6eepizvg.bkt.clouddn.com";
    //密钥配置
